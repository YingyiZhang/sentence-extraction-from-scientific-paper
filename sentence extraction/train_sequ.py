...
from evaluate_sequ import evaluate
import utils
import os
...
parser.add_argument('--aug', default=0, help="fold")
...
def train(model, data_iterator, optimizer, scheduler, params):
    ...
    for i in t:
        if params.isadjoin:
            batch_data, batch_data_before, batch_data_end, batch_tags, \
            batch_tags_before, batch_tags_end, max_len, batch_lengths = next(data_iterator)
        else:
        ...
        if params.isadjoin:
            loss = model(batch_data, data_before=batch_data_before, data_end=batch_data_end, token_type_ids=None,
                         ...
                         labels_before=batch_tags_before, labels_end=batch_tags_end,
...
def train_and_evaluate(model, train_data, val_data, optimizer, scheduler, params, model_dir, data_dir,
    ...
    for epoch in range(1, params.epoch_num + 1):
        ...
        #print ('params.val_steps', params.val_steps, 'params.train_steps',params.train_steps)
        ...
        val_metrics, pred_tags, pred_matrix = evaluate(model, val_data_iterator, params, epoch, mark='Val')
...
if __name__ == '__main__':
    ...
    train_data = data_loader.load_data(params.dataset+'/scibert/adjoin_train'+params.num, category='train')
